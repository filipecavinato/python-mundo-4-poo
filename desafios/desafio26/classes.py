...
class Funcionario(ABC):
    ...
    def analisar_salario(self):
        conteudo = f'O Salário de [blue]{self.nome}[/] ([purple]{type(self).__name__}[/]) é de [green]R$ {self.salario:,.2f}[/] e corresponde a [yellow]{self.salario/self.__class__.salario_minimo:.1f} Salários Mínimos[/].'
...
class FuncionarioHorista(Funcionario):
    ...
    def calculo_salario(self):
        self.salario = self.salario_bruto - ((self.__class__.inss/100) * self.salario_bruto)
        return self.salario
